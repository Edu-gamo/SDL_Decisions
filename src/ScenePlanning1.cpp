...
void ScenePlanning1::update(float dtime, SDL_Event *event)
{
...
bool ScenePlanning1::loadTextures(char* filename_bg, char* filename_coin)
{
...
Vector2D ScenePlanning1::cell2pix(Vector2D cell)
{
	int offset = CELL_SIZE / 2;
	return Vector2D(cell.x*CELL_SIZE + offset, cell.y*CELL_SIZE + offset);
}

Vector2D ScenePlanning1::pix2cell(Vector2D pix)
{
	return Vector2D((float)((int)pix.x / CELL_SIZE), (float)((int)pix.y / CELL_SIZE));
}

bool ScenePlanning1::isValidCell(Vector2D cell)
{
